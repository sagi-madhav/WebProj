...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.app.fullstack.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.app.fullstack.security.DomainUserDetailsService", "createSpringSecurityUser");
